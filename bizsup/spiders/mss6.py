...
class Mss6Spider(scrapy.Spider):
    name = "mss6"
    ...
    page_count = 0
    max_pages = 2
    items_selector = "div.board_list table tbody tr"
    ...
    next_page_url = "https://www.mss.go.kr/site/incheon/ex/bbs/List.do?cbIdx=246&pageIndex={next_page}"
    ...
    def __init__(self, *args, **kwargs):
        super(Mss6Spider, self).__init__(*args, **kwargs)
