...
class DgtpSpider(BaseSpider):
    name = "dgtp"
    allowed_domains = ['dgtp.or.kr']
    start_urls = ['https://dgtp.or.kr/bbs/BoardControll.do?bbsId=BBSMSTR_000000000003']
    base_url = 'https://dgtp.or.kr'
    output_dir = 'output/dgtp'
    page_count = 0
    max_pages = 2
    items_selector = "table.tablelist tbody tr td div.tooltip span a"


    # item_title_selector = "td div.tooltip span a::text"
    # click_selector = "table.tablelist tbody tr td div.tooltip a:nth-child(3)"
    # click_selector를 클릭할 수 없음.
    # 브로저 크기에 따라 table이 였다가 div로 바뀌는 경우가 있음.
    # https://dgtp.or.kr/bbs/BoardControllView.do?bbsId=BBSMSTR_000000000003&nttId=14771
    
    details_page_main_content_selector = "table.tableview"
    attachment_links_selector = "ul.attach li a"
    
    next_page_url = "https://dgtp.or.kr/bbs/BoardControll.do?bbsId=BBSMSTR_000000000003&pageIndex={next_page}"
    ...
    def __init__(self, *args, **kwargs):
        super(DgtpSpider, self).__init__(*args, **kwargs)
