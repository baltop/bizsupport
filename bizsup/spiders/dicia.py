...
class DiciaSpider(scrapy.Spider):
    name = "dicia"
    allowed_domains = ['dicia.or.kr']
    start_urls = ['https://www.dicia.or.kr/sub.do?menuIdx=MENU_000000000000055']
    base_url = 'https://dicia.or.kr'
    output_dir = 'output/dicia'
    page_count = 0
    max_pages = 2
    items_selector = "table.board.table tbody tr"
    item_num_selector = "td:nth-child(1)::text"

    item_title_selector = "td.bd-tit a::text"
    click_selector = "td.bd-tit a"

    details_page_main_content_selector = "div.sub-content"
    attachment_links_selector = "ul.file-list li div a.file_name.attach"
    
    next_page_url = "https://www.dicia.or.kr/sub.do?menuIdx=MENU_000000000000055&searchCnd=&searchWrd=&&pageIndex={next_page}"
    ...
    def __init__(self, *args, **kwargs):
        super(DiciaSpider, self).__init__(*args, **kwargs)
