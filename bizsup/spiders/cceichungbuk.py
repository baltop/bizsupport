...
class CceiChungbukSpider(BaseSpider):
    name = "cceiChungbuk"
    allowed_domains = ['creativekorea.or.kr']
    start_urls = ['https://ccei.creativekorea.or.kr/chungbuk/custom/notice_list.do']
    base_url = 'https://ccei.creativekorea.or.kr'
    output_dir = 'output/cceiChungbuk'
    page_count = 0
    max_pages = 2
    items_selector = "table.tbl1 tbody tr td a.tb_title"


    # item_title_selector = "td a.tb_title::text"
    # click_selector = "td a.tb_title"

    details_page_main_content_selector = "div.contentswrapper"
    attachment_links_selector = "div.vw_download span.dwnname"
    
    next_page_url = "https://ccei.creativekorea.or.kr/chungbuk/custom/notice_list.do?&page={next_page}"
    ...
    def __init__(self, *args, **kwargs):
        super(CceiChungbukSpider, self).__init__(*args, **kwargs)
    ...
    #             "PageMethod": [
    #                 # PageMethod("wait_for_selector", "a.tb_title"),
    #                 # PageMethod("wait_for_load_state", "load"),  # 페이지 로드 대기
